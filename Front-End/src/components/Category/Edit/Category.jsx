...
export default function EditCategory() {
    ...
    const fetchCategory = async () => {
        try {
            const res = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/categories/get/${id}`, { withCredentials: true, });
    ...
    const submit = async (e) => {
        ...
        try {
            ...
            await axios.put(`${import.meta.env.VITE_BACKEND_URL}/api/categories/edit/${id}`, payload,
