    ...
    return (
        <div className="flex min-h-screen bg-gray-100">
            ...
            <div className="flex-1">
                <Header user={user} name={"All Buyers"} openSideBar={openSideBar} setOpenSideBar={setOpenSideBar} />
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                        ...
                        <div className="flex flex-col md:flex-row items-center justify-between gap-4 px-5 py-4 border-t border-gray-200 bg-white">
                            <p className="text-sm text-gray-500">
                                ...
                                {" "}to{" "}
                                <span className="font-medium">
                                    {Math.min(currentPage * itemsPerPage, allBuyers.length)}
                                </span>
                                {" "}of{" "}
                                <span className="font-medium">
                                    {allBuyers.length}
